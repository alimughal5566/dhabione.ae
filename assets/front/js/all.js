        ...
        t(document).ready(function() {
            ...
            t(document).on("click", ".product-size .siz-list .box", function() {
                ...
                t.ajax({
                    ...
                    data: { id: e, itemid: i, size_qty: n, size_price: s },
                    success: function(e) {
                        b.addClass('adding');
                        0 == e || (t(".discount").html(t("#d-val").val()), t(".cart-total").html(e[0]), t(".main-total").html(e[3]), t(".coupon-total").val(e[3]), t("#prc" + i).html(e[2]), t("#prct" + i).html(e[2]), t("#cqt" + i).html(e[1]), t("#qty" + i).html(e[1]))
                    }
                })
            }), t(document).on("click", ".reducing", function() {
                var b = $(this);

                b.removeClass('reducing');
                ...
                o--, o < 1 ? (t("#qty" + i).html("1"), b.addClass('reducing')) : (t("#qty" + i).html(o), t.ajax({ type: "GET", url: mainurl + "/reducebyone", data: { id: e, itemid: i, size_qty: n, size_price: s }, success: function(e) { b.addClass('reducing'), t(".discount").html(t("#d-val").val()), t(".cart-total").html(e[0]), t(".main-total").html(e[3]), t(".coupon-total").val(e[3]), t("#prc" + i).html(e[2]), t("#prct" + i).html(e[2]), t("#cqt" + i).html(e[1]), t("#qty" + i).html(e[1]) } }))
