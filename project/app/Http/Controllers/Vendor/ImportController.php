        ...
        if (!empty($request->meta_tag)) 
         {
            ...
            // Set SLug
                ...
                $fimageData = Storage::disk('dos')->url('assets/images/products/'.$prod->photo);


                // Set Photo
            $img = Image::make($fimageData)->resize(800, 800)->encode('jpg');
            ...
            $img = Image::make($fimageData)->resize(285, 285)->encode('jpg');
                ...
                if ($files = $request->file('gallery')){
                    foreach ($files as  $key => $file){
                        if(in_array($key, $request->galval))
                        {
                            $gallery = new Gallery;
                            $name = time().$file->getClientOriginalName();
                            Storage::disk('dos')->putFileAs('/assets/images/galleries/',$file,$name);
