...
<div class="xzoom-container">
    <img class="quick-zoom" id="xzoom-magnific1" src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:Storage::disk('dos')->url('assets/images/products/'.$product->photo)}}" xoriginal="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:Storage::disk('dos')->url('assets/images/products/'.$product->photo)}}" />
    <div class="xzoom-thumbs">

      <div class="quick-all-slider">

          <a href="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:Storage::disk('dos')->url('assets/images/products/'.$product->photo)}}">
        <img class="quick-zoom-gallery" width="80" src="{{filter_var($product->photo, FILTER_VALIDATE_URL) ?$product->photo:Storage::disk('dos')->url('assets/images/products/'.$product->photo)}}" title="The description goes here">
          </a>

      @foreach($product->galleries as $gal)


          <a href="{{Storage::disk('dos')->url('assets/images/galleries/'.$gal->photo)}}">
        <img class="quick-zoom-gallery" width="80" src="{{Storage::disk('dos')->url('assets/images/galleries/'.$gal->photo)}}" title="The description goes here">
          </a>
