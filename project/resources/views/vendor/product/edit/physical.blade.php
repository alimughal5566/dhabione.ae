												...
												<div class="row">
													...
													<div class="col-lg-7">
														<div class="img-upload">
															<div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? Storage::disk('dos')->url('assets/images/products/'.$data->photo):asset('assets/images/noimage.png') }});">
                      ...
                      if(data[0] == 0)
                      {
        				...
        				$('.selected-image .row').append('<div class="col-sm-6">'+
                                        '<div class="img gallery-img">'+
                                            ...
                                            '</span>'+
                                            '<a href="'+'{{Storage::disk('dos')->url('assets/images/galleries').'/'}}'+arr[k]['photo']+'" target="_blank">'+
                                            '<img src="'+'{{Storage::disk('dos')->url('assets/images/galleries').'/'}}'+arr[k]['photo']+'" alt="gallery image">'+
                                            '</a>'+
                                        '</div>'+
                                  	'</div>');
                          }
...
$('.cropme').click();
  ...
  $(document).ready(function() {
    ...
    let html = `<img src="{{ empty($data->photo) ? asset('assets/images/noimage.png') : filter_var($data->photo, FILTER_VALIDATE_URL) ? $data->photo :Storage::disk('dos')->url('assets/images/products/'.$data->photo) }}" alt="">`;
