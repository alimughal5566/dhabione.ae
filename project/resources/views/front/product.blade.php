    ...
    <div class="col-lg-9">
        <div class="row">
          ...
          <div class="xzoom-container">
              <img class="xzoom5" id="xzoom-magnific" src="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:Storage::disk('dos')->url('assets/images/products/'.$productt->photo)}}" xoriginal="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:Storage::disk('dos')->url('assets/images/products/'.$productt->photo)}}" />
              <div class="xzoom-thumbs">

                <div class="all-slider">

                    <a href="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:Storage::disk('dos')->url('assets/images/products/'.$productt->photo)}}">
                  <img class="xzoom-gallery5" width="80" src="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:Storage::disk('dos')->url('assets/images/products/'.$productt->photo)}}" title="The description goes here">
                    </a>
                ...
                @foreach($productt->galleries as $gal)
                  ...
                  <img class="xzoom-gallery5" width="80" src="{{Storage::disk('dos')->url('assets/images/galleries/'.$gal->photo)}}" title="The description goes here">
                    </a>
